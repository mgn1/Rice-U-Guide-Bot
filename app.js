...
["M.D. Anderson Biological Laboratories (ABL)", "(m d anderson biological lab)|(abl)|((m\\.*d\\.*\\s)*anderson\\s(biological\\s)*lab((oratories)|(oratory))*)", "https://goo.gl/maps/GUr5RffcSju"],
["Anderson-Clarke Center (ACC)", "(anderson-clarke center)|(acc)|(anderson((-|\\s)+clarke)*\\scenter)", "https://goo.gl/maps/4anc5qKPDus"],
["M.D. Anderson Hall (ANH)", "(m d anderson hall)|(anh)|((m\\.*d\\.*\\s)*anderson\\shall)", "https://goo.gl/maps/KYpf6JNxeSr"],
["Abercromie Engineering Lab (AEL)", "(abercromie engineering lab)|(ael)|(abercrombie\\s(engineering\\slaboratory)*)", "https://goo.gl/maps/wPBxz7HHnxF2"],
["Allen Center (ALN)", "(allen center)|(aln)|(allen\\s(business\\s)*center)", "https://goo.gl/maps/SGGCSQvB8eJ2"],
["Margaret Root Brown College (BNC)", "(margaret root brown college)|(bnc)|(brown(\\scollege)*)", "https://goo.gl/maps/wvXbrkh3vgp"],
["conflict:Brown Hall", "brown\\shall"],
["Alice Pratt Brown Hall (APB)", "(alice pratt brown hall)|(apb)|((((alice\\s)*(pratt\\s)+)|((alice\\s)+(pratt\\s)*))brown\\shall)", "https://goo.gl/maps/toGFGJqMhin"],
["George R. Brown Hall (GRB)", "(george r brown hall)|(grb)|((((george\\s)*(r\\.*\\s)+)|((george\\s)+(r\\.*\\s)*))brown\\shall)", "https://goo.gl/maps/oMB2ztggJmk"],
["Herman Brown Hall for Math Sci (HBH)", "(herman brown hall for math sci)|(hbh)|(herman\\sbrown\\shall)", "https://goo.gl/maps/xc1Edcf4rsy"],
["Baker College (BKC)", "(baker college)|(bkc)|(baker(\\scollege)*)", "https://goo.gl/maps/W5NJNnAFW2q"],
["James Baker Hall (BKH)", "(james baker hall)|(bkh)|((james\\s(a\\.*\\s)*)*baker\\shall)", "https://goo.gl/maps/s5c2Ww5cTsS2"],
["conflict:Pavilion", "pavilion"],
["Booth Centennial Pavilion", "(booth\\s)*centennial\\spavilion", "https://goo.gl/maps/9wZWZCeSAsJ2"],
["Brochstein Pavilion (BPV)", "(brochstein pavilion)|(bpv)|(brochstein(\\spavilion)*)", "https://goo.gl/maps/9wZWZCeSAsJ2"],
["BioScience Research Collab (BRC)", "(bioscience research collab)|(brc)|(bioscience(\\sresearch)*(\\scollaborative)*)", "https://goo.gl/maps/54Md9RPF5L42"],
["Brockman Hall for Physics (BRK)", "(brockman hall for physics)|(brk)|(brockman(\\shall)*(\\sfor\\sphysics)*)", "https://goo.gl/maps/njYn4m7rakt"],
["Cohen House (COH)", "(cohen house)|(coh)|(cohen(\\shouse)*)", "https://goo.gl/maps/MroVJ9tfG522"],
["Dell Butcher Hall (DBH)", "(dell butcher hall)|(dbh)|(((dell\\s)+(butcher\\s)*)|((dell\\s)*(butcher\\s)+)hall)", "https://goo.gl/maps/M2U7GS7v98v"],
["Duncan College (DCC)", "(duncan college)|(dcc)|(duncan\\scollege)", "https://goo.gl/maps/U5w8gZ9gWFD2"],
["Anne and Charles Duncan Hall (DCH)", "(anne and charles duncan hall)|(dch)|(duncan\\shall)", "https://goo.gl/maps/Bi1oX3jU9ak"],
["Facilities Engr Planning Bldg (FEP)", "(facilities engr planning bldg)|(fep)|(facilities\\s(engineering and planning\\s)*building)", "https://goo.gl/maps/48giEEQKHr52"],
["Fondren Library (FON)", "(fondren library)|(fon)|(((fondren\\s)*(library)+)|((fondren)+\\s*(library)*))", "https://goo.gl/maps/rjZhEt4DPmH2"],
["Greenbriar Building (GBB)", "(greenbriar building)|(gbb)|(greenbriar(\\sbuilding)*)", "https://goo.gl/maps/S4q88t38iX72"],
["Greenhouse (GHS)", "(greenhouse)|(ghs)|(greenhouse)", "https://goo.gl/maps/cMVgGo6CC4J2"],
["Gibbs Rec and Wellness Center (GRW)", "(gibbs rec and wellness center)|(grw)|(((gibbs\\s)*rec(reation)*\\s(and\\swellness\\s)*center)|(gym))", "https://goo.gl/maps/WXVQGEqEwJF2"],
["Hamman Hall (HAM)", "(hamman hall)|(ham)|(hamman\\shall)", "https://goo.gl/maps/VqmcP2hFpDn"],
["Holloway Field and Ley Track (HFD)", "(holloway field and ley track)|(hfd)|(holloway(\\sfield)*)", "https://goo.gl/maps/6fdEGhsb8PA2"],
["Harry C Hanszen College (HNZ)", "(harry c hanszen college)|(hnz)|(hanszen(\\scollege)*)", "https://goo.gl/maps/Ko15SBHpRfP2"],
["Robert R Herring Hall (HRG)", "(.*herring.*)|(hrg)|((robert\\sr\.*\\s)*herring\\shall)", "https://goo.gl/maps/7vsFvrLtkco"],
["Herzstein Hall (HRZ)", "(herzstein hall)|(hrz)", "https://goo.gl/maps/NgTG6Qoou722"],
["Huff House (HUF)", "(huff house)|(huf)", "https://goo.gl/maps/FM8Q9CVtkuy"],
["Humanities Building (HUM)", "(humanities building)|(hum)", "https://goo.gl/maps/XKesMenuPar"],
...
["Jones College (JOC)", "(jones college)|(joc)|(jones)", "https://goo.gl/maps/X51ckCbXZx12"],
["Jones College Masters House", "jones(\\scollege)*(\\smaster)+.*(house)*", "https://goo.gl/maps/X51ckCbXZx12"],
["Howard Keck Hall (KCK)", "(howard keck hall)|(kck)|(kec\\shall)", "https://goo.gl/maps/LhoKRLHxLdD2"],
["Keith-Weiss Geological Lab (KWG)", "(keith-weiss geological lab)|(kwg)|(keith-*\\s*wiess\\s*(geological\\slaborator(ies)|y)*)", "https://goo.gl/maps/Gd53FZmieNk"],
["Ley Student Center (LEY)", "(ley student center)|(ley)", "https://goo.gl/maps/RjSgNEXuawr"],
["Lovett College (LVC)", "(lovett college)|(lovett)|(lvc)", "https://goo.gl/maps/38bZfTnfjZ52"],
["Lovett Hall (LVH)", "(lovett hall)|(lvh)", "https://goo.gl/maps/vdcciUGYHRx"],
["McMurtry College (MCM)", "(mcmurtry college)|(mcm)|(mcmurtry)", "https://goo.gl/maps/bUfj3r4ooAm"],
["Janice and Robert McNair Hall (MCN)", "(.*mcnair.*)|(mcn)", "https://goo.gl/maps/xbvGSC2u9gq"],
["Martel Center for Cont Studies (MCS)", "(martel center for cont studies)|(mcs)", "https://goo.gl/maps/J1hnhYiVydJ2"],
["Mechanical Engineering Bldg (MEB)", "(mechanical engineering bldg)|(meb)", "https://goo.gl/maps/W68jhRG9Zn42"],
["Media Center (MED)", "(media center)|(med)", "https://goo.gl/maps/bd97WVyMQpo"],
["Mechanical Laboratory (MEL)", "(mechanical laboratory)|(mel)", "https://goo.gl/maps/XCwQtshnjgs"],
["Martel College (MLC)", "(martel college)|(mlc)|(martel)", "https://goo.gl/maps/49K7eNMqhBF2"],
["S G Mudd Computer Science Lab", "(s g mudd computer science lab)|(.*mudd.*)", "https://goo.gl/maps/Qm9bLsEgUv52"],
["North Servery (NSV)", "(north servery)|(nsv)|(north)", "https://goo.gl/maps/5agW4LkomU22"],
["Oshman Engineer Design Kitchen (OEDK)", "(oshman engineer design kitchen)|(oedk)", "https://goo.gl/maps/D93h8MtvXey"],
["Rice University Police Department (RUPD)", "(.*police.*)|(pol)|(rupd)", "https://goo.gl/maps/5kKwi9gp53S2"],
["Rice Children's Campus (RCC)", "(rice children's campus)|(rcc)", "https://goo.gl/maps/kUGpmokVrEx"],
["Reckling Park at Cameron Field (RCK)", "(reckling park at cameron field)|(rck)", "https://goo.gl/maps/WsMJsD41aN82"],
["Rice Graduate Apartments (RGA)", "(rice graduate apartments)|(rga)", "https://goo.gl/maps/j6jAEtDUQ7T2"],
["Rice Health and Wellness Cntr (RHW)", "(rice health and wellness cntr)|(rhw)", "https://goo.gl/maps/gzJuEixXTZu"],
["Rice Memorial Center (RMC)", "(rice memorial center)|(rmc)", "https://goo.gl/maps/EuipxLCTrdp"],
["Rice Village Apartments (RVA)", "(rice village apartments)|(rva)", "https://goo.gl/maps/i5Md9yZNEPn"],
["Ryon Engineering Laboratory (RYN)", "(ryon engineering laboratory)|(ryn)", "https://goo.gl/maps/oQD8unXVkJo"],
["Rayzor Hall (RZR)", "(rayzor hall)|(rzr)|(rayzor)", "https://goo.gl/maps/DCvjNkpCE872"],
["Sewall Hall (SEW)", "(sewall hall)|(sew)|(sewall)", "https://goo.gl/maps/zaHsCqqwe6p"],
["South Plant (SPL)", "(south plant)|(spl)", "https://goo.gl/maps/dYqLh2DdN7J2"],
["Sid Richardson College (SRC)", "(sid richardson college)|(src)|(sid)|(sid rich)", "https://goo.gl/maps/YP5bYXohTCP2"],
["Space Science and Tech Bldg (SST)", "(space science and tech bldg)|(sst)", "https://goo.gl/maps/SJWfraBFJV42"],
["South Servery (SSV)", "(south servery)|(ssv)|(south)", "https://goo.gl/maps/BGGmY981uMx"],
["Rice Stadium (STA)", "(rice stadium)|(sta)", "https://goo.gl/maps/U2DX4dsA22n/"],
["To Be Announced", "(to be announced)|(tba)", "a to-be-announced location."], 
["Tudor Fieldhouse (TUD)", "(tudor fieldhouse)|(tud)|(tudor)", "https://goo.gl/maps/JfsuZKArcHr"],
["Wiess President's House (WPH)", "(wiess president's house)|(wph)", "https://goo.gl/maps/wfZqjZVPChs"],
["Will Rice College (WRC)", "(wrc)|(.*will rice.*)", "https://goo.gl/maps/AypESjPaey22"],
["Harry C Weiss College (WSC)", "(harry c weiss college)|(wsc)|(wiess)|(weiss)", "https://goo.gl/maps/97Rx2gFEEbP2"],
["West Servery (WSV)", "(west servery)|(wsv)|(west)", "https://goo.gl/maps/6kUsgQyi3h12"]];
